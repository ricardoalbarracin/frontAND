...
export class DatosPersonaNaturalForm {
    ...
    buildForm() {
        this.form = this.formBuilder.group({
            ...
            segundo_nombre: ['',   [Validators.required, Validators.min(2), Validators.max(25),Validators.pattern('^[A-Za-z]+$')]],
            primer_apellido: ['',  [Validators.required, Validators.min(2), Validators.max(25),Validators.pattern('^[A-Za-z]+$')]],
            segundo_apellido: ['', [Validators.required, Validators.min(2), Validators.max(25),Validators.pattern('^[A-Za-z]+$')]],
            calle_cra: [''],
