...
export class DatosDenunciadoPersonaNaturalForm {
    ...
    buildForm() {
        this.form = this.formBuilder.group({            
            ...
            segundo_nombre:['',   [Validators.min(2), Validators.max(25),Validators.pattern('^[A-Za-z]+$')]],
            primer_apellido:['',  [Validators.required, Validators.min(2), Validators.max(25),Validators.pattern('^[A-Za-z]+$')]],
            segundo_apellido:['', [Validators.min(2), Validators.max(25),Validators.pattern('^[A-Za-z]+$')]],
            direccion:['',Validators.required],   
            telefono_fijo: ['',[Validators.minLength(7), Validators.maxLength(10), Validators.pattern('^[0-9]+$')]],
            celular:['',[Validators.minLength(1), Validators.maxLength(10), Validators.pattern('^[0-9]+$')]],
            fax:['',[Validators.minLength(1), Validators.maxLength(10), Validators.pattern('^[0-9]+$')]],
