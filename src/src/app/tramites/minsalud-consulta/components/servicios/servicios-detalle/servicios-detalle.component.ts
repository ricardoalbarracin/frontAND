...
import { ServiciosDetalleModalComponent } from '../servicios-detalle-modal/servicios-detalle-modal.component';

@Component({
  selector: 'app-minsalud-consulta-servicios-detalle',
  templateUrl: './servicios-detalle.component.html',
  styleUrls: ['./servicios-detalle.component.scss']
})
export class ServiciosDetalleComponent implements OnInit {

  idsTablaServicios: string[] = ['departamento_prestador','municipio_prestador','codigo_prestador','nombre_sede_prestador','serv_nombre','dv'];
...
/*
 ...
 public setTablaDetalleDatos() {
  ...
  private abrirPopup = (e, item, index) => {
    const modal = this.modalService.open(ServiciosDetalleModalComponent, {
      size: 'lg',
      backdrop: 'static',
      keyboard: false,
      centered: true
