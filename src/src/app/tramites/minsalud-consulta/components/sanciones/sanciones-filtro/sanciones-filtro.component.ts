...
@Component({
  ...
  templateUrl: './sanciones-filtro.component.html',
  styleUrls: ['./sanciones-filtro.component.scss']
})
export class SancionesFiltroComponent implements OnInit {
  ...
  constructor(public concultaService: MinsaludConsultaUtilService,
    public sancionesDetalle: SancionesDetalleComponent) {
  ...
  descargarResultados() {
    this.concultaService.getDetalleExcel(this.concultaService.tipoDetalle.sanciones).subscribe(
      (data) => {
