...
import { SancionesDetalleModalComponent } from '../sanciones-detalle-modal/sanciones-detalle-modal.component';
...
@Component({
  ...
  templateUrl: './sanciones-detalle.component.html',
  styleUrls: ['./sanciones-detalle.component.scss']
})
export class SancionesDetalleComponent implements OnInit {
  ...
  idsTablaSanciones: string[] = ['nombre_prestador','codigo_prestador','departamento_prestador','municipio_prestador','serv_nombre','nombre_sede_prestador','numero_distintivo'];
  ...
  public inicializarTablaDetalleSanciones() {
    this.tDetail = {
      Header: [
...
/*
 ...
 public setTablaDetalleDatos() {
  ...
  private abrirPopup = (e, item, index) => {
    const modal = this.modalService.open(SancionesDetalleModalComponent, {
      size: 'lg',
      backdrop: 'static',
      keyboard: false,
      centered: true
